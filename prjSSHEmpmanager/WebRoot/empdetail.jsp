...
<table width="400" border="1" align="center" cellpadding="1" cellspacing="0">
  <tr>
    <td colspan="3" align="center" bgcolor="#FFFF99">员工详细信息</td>
  </tr>
  <tr>
    <td width="72">姓名</td>
    <td width="205">${demp.ename}</td>
    <td width="109" rowspan="7"><img src="uppic/${demp.photo}" width="109" height="160" /></td>
  </tr>
  <tr>
    <td>性别</td>
    <td>${demp.sex}</td>
  ...
  <tr>
    <td colspan="3" align="center" bgcolor="#FFFF99"><a href="findPageAll_Emp.action">查看列表</a></td>
  </tr>
</table>
<p align="center">&nbsp;</p>
</body>
