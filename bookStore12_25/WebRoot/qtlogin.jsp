...
<script type="text/javascript">
  ...
  <div class="t_Top">
	  ...
	  action ="<%=request.getContextPath()%>/UserLoginServlet" onkeydown="onkey(this,event);">
				...
				<div class="n_dl_c_l_b">
				  ...
				  <table width="262" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td height="35" colspan="3"><input type="text" name="username" id="username"  onblur="checkUserName()" value="" tabindex="1" class="input_35" />
                      <script language="javascript" type="text/javascript">
		              var msg='';
		              if(""!=msg){
                    ...
                    <tr>
                      ...
                      <input type="text" name="randNum" id="randNum" class="input_38" onblur="validateCode()" tabindex="3" />
                      ...
                      <td width="57" height="35">
                      	<img src="<%=request.getContextPath()%>/kaptcha" width="52" height="20" id="img" />
                      </td>
                      <td width="103" height="35"><a href="javascript:refreshCode();" class="color_57">看不清楚</a></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <input type="button" name="Submit" value="登 录" 
                      	onclick="check(this.form)"  tabindex="5" />
                      </td>
                    </tr>
                    <tr>
			...
			<div class="n_dl_c_r">
				...
				<div class="n_dl_c_r_b">
				  <table width="248" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td height="65" colspan="2" align="center"><input type="button" name="Submit2" value="立即免费注册易购" onclick="window.location='/memberRegister.do'" class="button_27" /></td>
                    </tr>
                  </table>
				</div>
