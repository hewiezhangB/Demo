...
<div class="top1">
	...
	<%
		...
		%>
		<div class="top1_1">
			   	欢迎您[<%=customerInfo.getCustName() %>]登云起点网上商城！用户名：<input type="text" name="name" value = "<%=customerInfo.getCustName() %>" class="inputsty"> 密码：<input type="text" name="password" class="inputsty"> <a href="#">忘记密码?</a> 
